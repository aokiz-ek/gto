...
export default function LoginPage() {
  ...
  const { login, loginWithOAuth, isLoading: authLoading, error: authError } = useSupabaseAuth();
      ...
      <Card variant="glass" padding="lg" animatedBorder style={{ width: '100%', maxWidth: '400px' }}>
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <p style={{ color: '#a0a0b0', fontSize: '14px' }}>
            Sign in to continue your GTO training
          </p>
        </div>
        ...
        <div style={{
          ...
          <Link href="/auth/register" style={{ color: '#00f5d4', fontWeight: 500 }}>
            Sign up
          </Link>
        </div>
      </Card>
